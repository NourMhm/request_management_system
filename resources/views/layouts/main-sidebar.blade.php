<!-- main-sidebar -->
		...
		<aside class="app-sidebar sidebar-scroll">
			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					<li class="side-item side-item-category">Request system</li>
					<li class="slide">
...
@can('اﻟﻤﺴﺘﺨﺪﻣﻴﻦ')
                    ...
                    <li class="slide">
                        <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                            ...
                            </svg><span class="side-menu__label">اﻟﻤﺴﺘﺨﺪﻣﻴﻦ</span><i class="angle fe fe-chevron-down"></i></a>
                        <ul class="slide-menu">

                                <li><a class="slide-item" href="{{ url('/' . ($page = 'users')) }}">ﻗﺎﺋﻤﺔ اﻟﻤﺴﺘﺨﺪﻣﻴﻦ</a></li>

                                <li><a class="slide-item" href="{{ url('/' . ($page = 'roles')) }}">ﺻﻼﺣﻴﺎﺕ اﻟﻤﺴﺘﺨﺪﻣﻴﻦ</a></li>
